...
CREATE OR REPLACE FUNCTION public.log_event(p_action text, p_action_scope public.audit_action_scope DEFAULT 'other'::public.audit_action_scope, p_entity_schema text DEFAULT NULL::text, p_entity_table text DEFAULT NULL::text, p_entity_type text DEFAULT NULL::text, p_entity_id text DEFAULT NULL::text, p_entity_ids jsonb DEFAULT NULL::jsonb, p_row_pk jsonb DEFAULT NULL::jsonb, p_old_data jsonb DEFAULT NULL::jsonb, p_new_data jsonb DEFAULT NULL::jsonb, p_diff jsonb DEFAULT NULL::jsonb, p_success boolean DEFAULT true, p_status_code integer DEFAULT NULL::integer, p_error_code text DEFAULT NULL::text, p_error_message text DEFAULT NULL::text, p_latency_ms integer DEFAULT NULL::integer, p_metadata jsonb DEFAULT '{}'::jsonb, p_request_id uuid DEFAULT NULL::uuid, p_trace_id text DEFAULT NULL::text, p_user_id uuid DEFAULT NULL::uuid)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
create or replace view "public"."v_recent_events" as  SELECT audit_log.id,
...
grant delete on table "public"."package_preset_rooms" to "anon";

grant insert on table "public"."package_preset_rooms" to "anon";

grant references on table "public"."package_preset_rooms" to "anon";

grant select on table "public"."package_preset_rooms" to "anon";

grant trigger on table "public"."package_preset_rooms" to "anon";

grant truncate on table "public"."package_preset_rooms" to "anon";

grant update on table "public"."package_preset_rooms" to "anon";

grant delete on table "public"."package_preset_rooms" to "authenticated";

grant insert on table "public"."package_preset_rooms" to "authenticated";

grant references on table "public"."package_preset_rooms" to "authenticated";

grant select on table "public"."package_preset_rooms" to "authenticated";

grant trigger on table "public"."package_preset_rooms" to "authenticated";

grant truncate on table "public"."package_preset_rooms" to "authenticated";

grant update on table "public"."package_preset_rooms" to "authenticated";

grant delete on table "public"."package_preset_rooms" to "service_role";

grant insert on table "public"."package_preset_rooms" to "service_role";

grant references on table "public"."package_preset_rooms" to "service_role";

grant select on table "public"."package_preset_rooms" to "service_role";

grant trigger on table "public"."package_preset_rooms" to "service_role";

grant truncate on table "public"."package_preset_rooms" to "service_role";

grant update on table "public"."package_preset_rooms" to "service_role";

grant delete on table "public"."package_presets" to "anon";

grant insert on table "public"."package_presets" to "anon";

grant references on table "public"."package_presets" to "anon";

grant select on table "public"."package_presets" to "anon";

grant trigger on table "public"."package_presets" to "anon";

grant truncate on table "public"."package_presets" to "anon";

grant update on table "public"."package_presets" to "anon";

grant delete on table "public"."package_presets" to "authenticated";

grant insert on table "public"."package_presets" to "authenticated";

grant references on table "public"."package_presets" to "authenticated";

grant select on table "public"."package_presets" to "authenticated";

grant trigger on table "public"."package_presets" to "authenticated";

grant truncate on table "public"."package_presets" to "authenticated";

grant update on table "public"."package_presets" to "authenticated";

grant delete on table "public"."package_presets" to "service_role";

grant insert on table "public"."package_presets" to "service_role";

grant references on table "public"."package_presets" to "service_role";

grant select on table "public"."package_presets" to "service_role";

grant trigger on table "public"."package_presets" to "service_role";

grant truncate on table "public"."package_presets" to "service_role";

grant update on table "public"."package_presets" to "service_role";

grant delete on table "public"."user_subscription_rooms" to "anon";

grant insert on table "public"."user_subscription_rooms" to "anon";

grant references on table "public"."user_subscription_rooms" to "anon";

grant select on table "public"."user_subscription_rooms" to "anon";

grant trigger on table "public"."user_subscription_rooms" to "anon";

grant truncate on table "public"."user_subscription_rooms" to "anon";

grant update on table "public"."user_subscription_rooms" to "anon";

grant delete on table "public"."user_subscription_rooms" to "authenticated";

grant insert on table "public"."user_subscription_rooms" to "authenticated";

grant references on table "public"."user_subscription_rooms" to "authenticated";

grant select on table "public"."user_subscription_rooms" to "authenticated";

grant trigger on table "public"."user_subscription_rooms" to "authenticated";

grant truncate on table "public"."user_subscription_rooms" to "authenticated";

grant update on table "public"."user_subscription_rooms" to "authenticated";

grant delete on table "public"."user_subscription_rooms" to "service_role";

grant insert on table "public"."user_subscription_rooms" to "service_role";

grant references on table "public"."user_subscription_rooms" to "service_role";

grant select on table "public"."user_subscription_rooms" to "service_role";

grant trigger on table "public"."user_subscription_rooms" to "service_role";

grant truncate on table "public"."user_subscription_rooms" to "service_role";

grant update on table "public"."user_subscription_rooms" to "service_role";
...
with check ((auth.role() = 'service_role'::text));
  ...
  for select
  to authenticated
using (((auth.role() = 'service_role'::text) OR COALESCE(((auth.jwt() ->> 'role'::text) = 'admin'::text), false) OR COALESCE(((auth.jwt() ->> 'is_admin'::text))::boolean, false)));
